...
static const void * ReadInvalid( u32 address )
{
	...
	u8* temp = g_pMemoryBuffers[MEM_UNUSED].get();
...
static const void * ReadMapped( u32 address )
{
	...
	else
	{
		...
		return g_pMemoryBuffers[MEM_UNUSED].get();
	}
}
...
static const void * Read_8000_807F( u32 address )
{
	...
	return g_pMemoryBuffers[MEM_RD_RAM].get() + (address & 0x007FFFFF);
}
...
static const void * Read_83F0_83F0( u32 address )
{
	...
	#endif
	return g_pMemoryBuffers[MEM_RD_REG0].get() + (address & 0xFF);
}
...
static const void * Read_8400_8400( u32 address )
{
	...
	#endif
	return g_pMemoryBuffers[MEM_SP_MEM].get() + (address & 0x1FFF);
}
...
static const void * Read_8404_8404( u32 address )
{
	...
	#endif
	return g_pMemoryBuffers[MEM_SP_REG].get() + (address & 0xFF);
}
...
static const void * Read_8408_8408( u32 address )
{
	...
	#endif
	return g_pMemoryBuffers[MEM_SP_PC_REG].get() + (address & 0xFF);
}
...
static const void * Read_8410_841F( u32 address )
{
	...
	#endif
	return g_pMemoryBuffers[MEM_DPC_REG].get() + (address & 0xFF);
}
...
static const void * Read_8430_843F( u32 address )
{
	...
	#endif
	return g_pMemoryBuffers[MEM_MI_REG].get() + (address & 0xFF);
}
...
static const void * Read_8440_844F( u32 address )
{
	...
	u8* temp = g_pMemoryBuffers[MEM_VI_REG].get() + offset;
...
static const void * Read_8450_845F( u32 address )
{
	...
	#endif
	return g_pMemoryBuffers[MEM_AI_REG].get() + (address & 0xFF);
}
...
static const void * Read_8460_846F( u32 address )
{
	...
	#endif
	return g_pMemoryBuffers[MEM_PI_REG].get() + (address & 0xFF);
}
...
static const void * Read_8470_847F( u32 address )
{
	...
	#endif
	return g_pMemoryBuffers[MEM_RI_REG].get() + (address & 0xFF);
}
...
static const void * Read_8480_848F( u32 address )
{
	...
	#endif
	return g_pMemoryBuffers[MEM_SI_REG].get() + (address & 0xFF);
}
...
static const void * Read_9FC0_9FCF( u32 address )
{
	...
	#endif
	return g_pMemoryBuffers[MEM_PIF_RAM].get() + pif_ram_offset;
}
