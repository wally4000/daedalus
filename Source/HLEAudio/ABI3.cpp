...
static void DISABLE(const AudioHLECommand& command) {}
static void WHATISTHIS(const AudioHLECommand& command) {}

static void MP3ADDY(const AudioHLECommand& command) {
