...
#define dmem (g_pMemoryBuffers[MEM_SP_MEM].get() + SP_DMA_DMEM)
#define imem (g_pMemoryBuffers[MEM_SP_MEM].get() + SP_DMA_IMEM)
#define rdram (g_pMemoryBuffers[MEM_RD_RAM].get())
