...
std::unique_ptr<CUIComponentScreen>	CUIComponentScreen::Create( CUIContext * p_context, std::unique_ptr<CUIComponent> component, const char * title )
{
	return std::make_unique<CUIComponentScreen>( p_context, std::move(component), title );
}
